...
Controleur::Controleur(const std::string& fichierEntree, int delaiMs)
...
void Controleur::lancerModeConsole() {
...
void Controleur::lancerModeGraphique() {
    vue.afficherConsole(grille); // Afficher la grille initiale dans la console
    ...
    while (fenetre.isOpen()) {
        ...
        if (enCours) {
            ...
            vue.afficherGraphique(grille, fenetre);
            fenetre.display();
